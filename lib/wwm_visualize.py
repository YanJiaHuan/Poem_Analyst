...
# Replace the path below with the path to your font file
# font_path = "../Noto_Sans_SC/NotoSansSC-Regular.otf"
...
word_list = ["床","明","光","须","臾","百","云","藓","痕","子","孙","惆","怅","狂","风","猛","猛雨","凤","凰"]  # replace with actual words
